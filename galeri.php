...
<div class="row">
    <div class="col-md-4 mb-4">
        <div class="card shadow-sm">
            <img src="images/test.gif" class="card-img-top" alt="Foto 1">
            <div class="card-body">
    ...
    <div class="col-md-4 mb-4">
        <div class="card shadow-sm">
            <img src="images/test.gif" class="card-img-top" alt="Foto 2">
            <div class="card-body">
    ...
    <div class="col-md-4 mb-4">
        <div class="card shadow-sm">
            <img src="images/test.gif" class="card-img-top" alt="Foto 3">
            <div class="card-body">
