...
<h2 class="my-4">Struktur Organisasi</h2>

<div class="card mb-4 shadow-sm">
    <div class="card-header">
        <h3>Struktur Organisasi FTIK</h3>
    </div>
    <div class="card-body">
        <p>Berikut adalah struktur organisasi FTIK:</p>
        <ul>
            <li>Dekan</li>
            <li>Wakil Dekan</li>
            <li>Kepala Program Studi Teknik Informatika</li>
            <li>Kepala Program Studi Sistem Informasi</li>
            <li>Kepala Program Studi Kajian Film, TV dan Media</li>
            <li>Tenaga Pendidik dan Kependidikan</li>
        </ul>
    </div>
</div>
